...
public class PanelRound extends JPanel {
    ...
    protected void paintComponent(Graphics g) {
        ...
        Color transparentWhite = new Color(255, 255, 255, 150); // Adjust alpha for desired transparency
        ...
        // Fill the rounded shape with the transparent color
        g2.fill(area);
        g2.dispose();
